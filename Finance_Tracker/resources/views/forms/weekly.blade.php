...
<body class="bg-gradient-to-br from-gray-900 to-gray-700 text-white min-h-screen">
    ...
    <div class="container mx-auto mt-32 px-4">
        <h2 class="text-center text-4xl font-bold text-white mb-8">Enter Your Weekly Amount</h2>
        <div class="max-w-lg mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
            <form action="{{ route('weekly.store') }}" method="POST">
                @csrf
                <!-- Weekly Amount Field -->
                <div class="mb-6">
                    <label for="weekly" class="block text-sm font-medium text-gray-300 mb-2">Weekly Amount</label>
                    <input type="number" id="weekly" name="amount" placeholder="Enter your weekly amount"
